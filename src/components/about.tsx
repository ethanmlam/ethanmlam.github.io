      ...
      >
        ...
        {/* Additional text content and buttons can be added here */}
          <Text fontWeight="20" fontSize={headingSize}>
              I’m a 4th year at University of California, Berkeley studying Electrical Engineering and Computer Science (EECS) and Industrial Engineering and Operations Research (IEOR), providing me a holistic perspective within hardware, software, and organizational contexts. 
